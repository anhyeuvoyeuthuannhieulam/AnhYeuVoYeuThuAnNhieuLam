const CONFIG = {
    titleWeb: "anhyeuvoyeuthuan",
    introTitle: 'Vợ yêu Thu An',
    introDesc: `Anh yêu vợ yêu nhiều lắm, vợ cho anh xin lỗi nhé, anh biết lỗi của mình rồi <`,
    btnIntro: '^^Yêu vợ nhiều lắm^^',
